...
public class LecDataDTO {
	...
	private Timestamp lec_data_regdate;
	...
	public Timestamp getLec_data_regdate() {
		return lec_data_regdate;
	}
	...
	public void setLec_data_regdate(Timestamp lec_data_regdate) {
		this.lec_data_regdate = lec_data_regdate;
	}
