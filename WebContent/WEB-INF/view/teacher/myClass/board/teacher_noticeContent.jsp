	...
	<table class="tableWrap">
		<tr><td>
			<table class="table">
				...
				<tr>
					<td>첨부파일</td>
					<td><a href="/mooc/Download.mooc?fileName=${lecNotice_dto.lec_n_file}">${lecNotice_dto.lec_n_file} 다운로드</a></td>
				</tr>
				<tr>
					<td colspan="6" align="right">
						<input type="button" value="수정" onclick="document.location.href='/mooc/teacher/noticeModify.mooc?lec_n_num=${lecNotice_dto.lec_n_num }'" />	
						<input type="button" value="삭제" onclick="document.location.href='/mooc/teacher/noticeDelete.mooc?lec_n_num=${lecNotice_dto.lec_n_num}'" />
						<input type="button" value="목록" onclick="document.location.href='/mooc/teacher/noticeList.mooc?main_lec_code=${lecNotice_dto.main_lec_code}&pageNum=${pageNum}'" />
					</td>
				</tr>
			</table>
		</td></tr>
