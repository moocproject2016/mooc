...
<div class="page-header">
  <h1>Lecture_review <small>강의 평가 작성</small></h1>
</div>
  <form method="post" action="http://localhost:8000/mooc/user/review.mooc" name="review">
  <table width="800" align="center" border="1" border-color="black"/>
     <tr>
     <td colspan="5" width="50%" >질문 내용<input type="hidden" value="${main_lec_code}">
     </td>
