			...
			<table class="table"  align="center">
				...
				<tr>
					...
					<td colspan="6" align="right">
						<input type="button" value="목록" onclick="document.location.href='/mooc/user/user_notice.mooc?main_lec_code=${lecNotice_dto.main_lec_code}&pageNum=${pageNum}'" />
					</td>
					</c:if>
					<c:if test='${check==1}'>
						<td colspan="6" align="right">
							<input type="button" value="목록" onclick="document.location.href='/mooc/user/myStudy.mooc?check=1'" />
						</td>
					</c:if>
				</tr>
			</table>
