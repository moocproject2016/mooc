...
<body onload="submitCheck();">
	...
	<table class="table" align="center">
		...
		<tr>
			...
			<td align="center"><a href="/mooc/notice_download.mooc?fileName=${dto.notice_file}">${dto.notice_file} 다운로드</a></td>
		</tr>
		<tr>
			<td colspan="6" align="right">
				<input type="button" value="목록" onclick="document.location.href='notice.mooc?pageNum=${pageNum}'" />
			</td>
		</tr>
	</table>
</body>