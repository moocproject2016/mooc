...
<div class="container">
	<div class="row">
		<div class="page-header">
			<h1>Starting Soon! <small>아래의 실시간 강의가 곧 시작합니다.</small>	</h1>
			<a href="">더 보기</a>
		</div>
		<c:forEach	items="${main_liveLecture_List}" var="mll">
			<div class="col-md-4">
			    ...
			    <p><a class="btn btn-default" href="/mooc/viewMainLec.mooc?main_lec_code=${mll.main_lec_code}" role="button">View details &raquo;</a></p>
		  	</div>
		</c:forEach>  	
	</div>
	<div class="row">
		<div class="page-header">
			<h2>Popular Courses 베스트 강의!</h2>
			<a href="">더 보기</a>
		</div>
		<c:forEach	items="${main_bestLecture_List}" var="mbl">
			<div class="col-md-4">
			    ...
			    <p><a class="btn btn-default" href="/mooc/viewMainLec.mooc?main_lec_code=${mbl.main_lec_code}" role="button">View details &raquo;</a></p>
		  	</div>
		</c:forEach>
	</div>
		<div class="row">
		<div class="page-header">
			<h2>Popular Teachers 인기 강의!</h2>
			<a href="">더 보기</a>
		</div>
		<c:forEach	items="${main_popularLectureList}" var="mpl">
			<div class="col-md-4">
			    ...
			    <p><a class="btn btn-default" href="/mooc/viewMainLec.mooc?main_lec_code=${mpl.main_lec_code}" role="button">View details &raquo;</a></p>
		  	</div>
		</c:forEach>  	
	</div>
</div>